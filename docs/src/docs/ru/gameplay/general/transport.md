...
```
> Подробнее о новых скриптовых экспортах можно прочесть [тут](https://github.com/ixray-team/ixray-1.6-stcop/wiki/Lua:-%D0%A4%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D0%B8#ccar).
## UI Индикаторы
