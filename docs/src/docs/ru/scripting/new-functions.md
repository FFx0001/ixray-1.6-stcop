...
```
* [Бустеры](https://github.com/ixray-team/ixray-1.6-stcop/wiki/Lua:-Enums#eboostparams)
```cpp
...
```
## [animslot](https://github.com/ixray-team/ixray-1.6-stcop/wiki/HUD:-%D0%90%D0%BD%D0%B8%D0%BC%D0%B0%D1%86%D0%B8%D0%B8)
```lua
animslot.play(section, anim) //-- Проиграть анимацию на худе 
```

## [CEatableItem](https://github.com/ixray-team/ixray-1.6-stcop/wiki/Используемые-предметы)
* Функции
```cpp
